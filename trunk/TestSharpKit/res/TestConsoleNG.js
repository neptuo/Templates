...
var TestConsoleNG$Extensions$BindingExtension =
{
    ...
    definition:
    {
        ...
        ProvideValue: function (context)
        {
            ...
            if (data == null)
                return null;
            if (context.get_TargetProperty().get_PropertyType().IsAssignableFrom(data.GetType()))
                return data;
            if (context.get_TargetProperty().get_PropertyType().IsAssignableFrom(Typeof(System.String.ctor)))
                return data.toString();
            var converter = System.ComponentModel.TypeDescriptor.GetConverter$$Object(data);
            if (converter.CanConvertTo$$Type(context.get_TargetProperty().get_PropertyType()))
                return converter.ConvertTo$$Object$$Type(data, context.get_TargetProperty().get_PropertyType());
            throw $CreateException(new System.InvalidOperationException.ctor$$String("Unnable to convert to target type!"), new Error());
        }
    }
};
