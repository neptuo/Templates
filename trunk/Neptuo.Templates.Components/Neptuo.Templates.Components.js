    ...
    definition:
    {
        ...
        CastValueTo$1: function (T, value)
        {
            ...
            if (converter.CanConvertTo$$Type(targetType))
                return converter.ConvertTo$$Object$$Type(value, targetType);
...
var Neptuo$Templates$ComponentManager$ObserverInfo =
{
    ...
    ctors: [ {name: "ctor", parameters: ["Neptuo.Templates.Observers.IObserver", "System.Delegate"]}],
    IsAbstract: true
};
...
var Neptuo$Templates$ComponentManager$ObserverInfo$1 =
{
    ...
    ctors: [ {name: "ctor", parameters: ["T", "System.Action"]}],
    IsAbstract: false
};
...
var Neptuo$Templates$HtmlAttribute =
{
    ...
    ctors: [ {name: "ctor$$String", parameters: ["System.String"]}, {name: "ctor$$String$$Boolean", parameters: ["System.String", "System.Boolean"]}],
    IsAbstract: false
};
...
var Neptuo$Templates$IAttributeCollection = {fullname: "Neptuo.Templates.IAttributeCollection", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$IAttributeCollection);
var Neptuo$Templates$Controls$IContentControl = {fullname: "Neptuo.Templates.Controls.IContentControl", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", interfaceNames: ["Neptuo.Templates.Controls.IControl"], Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$Controls$IContentControl);
var Neptuo$Templates$Controls$IControl = {fullname: "Neptuo.Templates.Controls.IControl", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$Controls$IControl);
var Neptuo$Templates$Extensions$IValueExtension = {fullname: "Neptuo.Templates.Extensions.IValueExtension", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$Extensions$IValueExtension);
var Neptuo$Templates$Extensions$IValueExtensionContext = {fullname: "Neptuo.Templates.Extensions.IValueExtensionContext", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$Extensions$IValueExtensionContext);
var Neptuo$Templates$IHtmlWriter = {fullname: "Neptuo.Templates.IHtmlWriter", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$IHtmlWriter);
var Neptuo$Templates$IComponentManager = {fullname: "Neptuo.Templates.IComponentManager", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
...
var Neptuo$Templates$ControlInitCompleteEventArgs =
{
    ...
    ctors: [ {name: "ctor", parameters: ["Neptuo.Templates.Controls.IControl"]}],
    IsAbstract: false
};
JsTypes.push(Neptuo$Templates$ControlInitCompleteEventArgs);
var Neptuo$Templates$IViewPage = {fullname: "Neptuo.Templates.IViewPage", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", interfaceNames: ["Neptuo.Templates.Controls.IContentControl", "System.IDisposable"], Kind: "Interface", ctors: [], IsAbstract: true};
JsTypes.push(Neptuo$Templates$IViewPage);
var Neptuo$Templates$IVirtualUrlProvider = {fullname: "Neptuo.Templates.IVirtualUrlProvider", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
...
var Neptuo$Templates$ObserverLivecycle =
{
    ...
    staticDefinition: {PerAttribute: 0, PerControl: 1, PerPage: 2},
    Kind: "Enum",
    ctors: [ {name: "ctor", parameters: []}],
    IsAbstract: false
};
JsTypes.push(Neptuo$Templates$ObserverLivecycle);
var Neptuo$Templates$Observers$IObserver = {fullname: "Neptuo.Templates.Observers.IObserver", baseTypeName: "System.Object", assemblyName: "Neptuo.Templates.Components", Kind: "Interface", ctors: [], IsAbstract: true};
