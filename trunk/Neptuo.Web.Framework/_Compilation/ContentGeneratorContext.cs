...
{
    public class ContentGeneratorContext : XGeneratorContext
    {
        public CodeGeneratorService GeneratorService { get; set; }

        public XGeneratorContext GeneratorContext { get; set; }

        public ContentGeneratorContext(XGeneratorContext compilerContext, CodeGeneratorService compilerService)
        {
